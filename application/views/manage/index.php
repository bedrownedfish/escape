...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('public/manage/')?>css/adminstyle.css" media="all">
	...
	<div class="layui-header header header-demo">
		<div class="layui-main">
			...
			<div class="admin-logo-box">
				<a class="logo" href="<?=base_url()?>" title="logo">后台管理系统</a>
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                   <dd>
                        <a href="javascript:;" data-url="<?=base_url('manage/setConfig')?>">
                            <i class="iconfont icon-geren1" data-icon='icon-geren1'></i>
                            <span>系统设置</span>
                        </a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-url="<?=base_url('manage/changepwd')?>">
                            <i class="iconfont icon-iconfuzhi01" data-icon='icon-iconfuzhi01'></i>
                            <span>修改系统密码</span>
                        </a>
                    </dd>
                    <dd>
					    <a href="javascript:;" data-url="<?=base_url('manage/newsAdd')?>">
			...
			<li class="layui-nav-item">
					<a href="javascript:;">
					   ...
					   <em class="layui-nav-more"></em>
					    ...
					    <dl class="layui-nav-child">
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('manage/table')?>">
					    		   <i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>
					    		   <span>用户列表</span>
					    		</a>
					    	</dd>
					    	<!-- <dd>
					    		<a href="javascript:;"  data-url="<?=base_url('manage/table_1')?>">
					    		   <i class="iconfont icon-jiaoseguanli4" data-icon='icon-jiaoseguanli4'></i>
					    		   <span>无线条输入增加内容框</span>
					    		</a>
					    	</dd> 
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('manage/dealrecordSend')?>">
					    		   <i class="iconfont icon-quanxian2" data-icon='icon-quanxian2'></i>
					    		   <span>平台转账记录</span>
					    		</a>
					    	</dd>
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('manage/dealrecordReceive')?>">
			...
			<li class="layui-nav-item">
					<a href="javascript:;">
					   ...
					   <dl class="layui-nav-child">
					   	   <dd>
					    		<a href="javascript:;" data-url="<?=base_url('news/slide')?>">
					    		   <i class="iconfont icon-lanmuguanli" data-icon='icon-lanmuguanli'></i>
					    		   <span>轮播图管理</span>
					    		</a>
					    	</dd>
					    	<!--<dd>
					    		<a href="javascript:;" data-url="<?=base_url('news/newList')?>">
					    		   <i class="iconfont icon-wenzhang2" data-icon='icon-wenzhang2'></i>
					    		   <span>新闻公告列表</span>
					    		</a>
					    	</dd>
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('news/newsAdd')?>">
					    		   <i class="iconfont icon-icon1" data-icon='icon-icon1'></i>
					    		   <span>新增新闻</span>
					    		</a>
					    	</dd>
				...
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
                           <dd>
                           	   <a href="javascript:;" data-url="<?=base_url('Kinds/kindList')?>">
                           ...
                           <dd>
					    		<a href="javascript:;" data-url="<?=base_url('Kinds/price')?>">
					    		   <i class="iconfont icon-word" data-icon='icon-word'></i>
					    		   <span>设置H链价格</span>
					    		</a>
					    	</dd>
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('Kinds/setRatio')?>"> 
					    		   <i class="iconfont icon-pinglun1" data-icon='icon-pinglun1'></i>
					    		   <span>汇率设置</span>
					    		</a>
					    	</dd>
				...
				<!--<li class="layui-nav-item">
					<a href="javascript:;">
					   ...
					   <dl class="layui-nav-child">
							<dd>
                           	   <a href="javascript:;" data-url="<?=base_url('Kinds/opinion')?>">
					              <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
					              <span>用户反馈</span>
					           </a>
							</dd>
					    	...
					    	<dd>
					    		<a href="javascript:;" data-url="<?=base_url('Kinds/common')?>">
		...
		<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
			...
			<div class="layui-tab-content" style="min-height: 150px; ">
				<div class="layui-tab-item layui-show">
					<iframe class="larry-iframe" data-id='0' src="<?=base_url('manage/main')?>"></iframe>
				</div>
			</div>
		</div>
	</div>
...
<!-- 加载js文件-->                                                                                                                                                                                           
	...
	<script type="text/javascript" src="<?=base_url('public/manage/')?>js/larry.js"></script>
	<script type="text/javascript" src="<?=base_url('public/manage/')?>js/index.js"></script>
...
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		...
		<div class="lock-box center">
			<img src="<?=base_url('public/manage/')?>images/userimg.jpg" alt="">
			<h1>admin</h1>
